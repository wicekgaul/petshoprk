            ...
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <form class="form" action="/Peliharaan/update/<?= $item->Peliharaan_id ?>" method="post">
                            <div class="row">
                                <!-- Left Column -->
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <select class="choices form-select" style="width: 100%;" name="Pemilik_id">
                                            ...
                                            <option value="<?= $value->Pemilik_id ?>" 
                                                <?= $value->Pemilik_id == $item->Pemilik_id ? 'selected' : '' ?>>
                                                <?= $value->Nama ?>
                                            </option>
                                            <?php endforeach; ?>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="last-name-column" class="form-control form-control-lg"
                                            placeholder="Nama Hewan" name="Nama" value="<?= $item->Nama ?>">
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="col-12 d-flex justify-content-end">
                                ...
                                <a href="/Peliharaan" class="btn btn-light-secondary me-1 mb-1">Cancel</a>
                            </div>
                    </div>
                    </form>
                </div>
