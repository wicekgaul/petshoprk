    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item <?= $uri->getSegment(1) === 'Pemilik' ? 'active' : '' ?>">
                    <a href="/Pemilik" class='sidebar-link'>
                        <i class="bi bi-grid-fill"></i>
                        <span>Pemilik</span>
                    </a>
                </li>
                <li class="sidebar-item <?= $uri->getSegment(1) === 'Peliharaan' ? 'active' : '' ?>">
                    <a href="/Peliharaan" class='sidebar-link '>
                        <i class="bi bi-grid-fill"></i>
                        <span>Peliharaan</span>
                    </a>
                </li>
                <li class="sidebar-item <?= $uri->getSegment(1) === 'Dokter' ? 'active' : '' ?>">
                    <a href="/Dokter" class='sidebar-link'>
                        <i class="bi bi-grid-fill"></i>
                        <span>Dokter</span>
                    </a>
                </li>
                <?php elseif (session()->get('user')['Role'] == 'dokter'):?>

                <li class="sidebar-item <?= $uri->getSegment(1) === 'Dashboard' ? 'active' : '' ?>">
                    <a href="/Dashboard" class='sidebar-link'>
                        <i class="bi bi-grid-fill"></i>
                        <span>Dashboard</span>
                    </a>
                </li>
                <li class="sidebar-item <?= $uri->getSegment(1) === 'Rekammedik' ? 'active' : '' ?>">
                    <a href="/Rekammedik" class='sidebar-link'>
                        <i class="bi bi-grid-fill"></i>
                        <span>Rekam Medik</span>
                    </a>
                </li>
                <li class="sidebar-item <?= $uri->getSegment(1) === 'Obat' ? 'active' : '' ?>">
